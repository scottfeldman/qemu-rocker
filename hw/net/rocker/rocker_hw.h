...
#define ROCKER_GROUP_TUNNEL_ID_MASK 0x0ffff0000
#define ROCKER_GROUP_SUBTYPE_SHIFT 10
#define ROCKER_GROUP_SUBTYPE_MASK 0x00000c000
#define ROCKER_GROUP_INDEX_SHIFT 0
#define ROCKER_GROUP_INDEX_MASK 0x00000ffff
#define ROCKER_GROUP_INDEX_LONG_SHIFT 0
#define ROCKER_GROUP_INDEX_LONG_MASK 0x0ffffffff
...
#define ROCKER_GROUP_PORT_GET(port) \
    (((port) & ROCKER_GROUP_PORT_MASK) >>ROCKER_GROUP_PORT_SHIFT)
#define ROCKER_GROUP_PORT_SET(port) \
    (((port) << ROCKER_GROUP_PORT_SHIFT) & ROCKER_GROUP_PORT_MASK)
#define ROCKER_GROUP_INDEX_GET(port) \
    (((port) & ROCKER_GROUP_INDEX_MASK) >>ROCKER_GROUP_INDEX_SHIFT)
#define ROCKER_GROUP_INDEX_SET(port) \
    (((port) << ROCKER_GROUP_INDEX_SHIFT) & ROCKER_GROUP_INDEX_MASK)
#define ROCKER_GROUP_INDEX_LONG_GET(port) \
    (((port) & ROCKER_GROUP_INDEX_LONG_MASK) >>ROCKER_GROUP_INDEX_LONG_SHIFT)
#define ROCKER_GROUP_INDEX_LONG_SET(port) \
    (((port) << ROCKER_GROUP_INDEX_LONG_SHIFT) & \
