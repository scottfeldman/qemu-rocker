...
enum {
    ...
    ROCKER_TLV_CMD_TYPE_OF_DPA_ADD,
    ROCKER_TLV_CMD_TYPE_OF_DPA_MOD,
    ROCKER_TLV_CMD_TYPE_OF_DPA_DEL,
    ROCKER_TLV_CMD_TYPE_OF_DPA_GET_STATS,
...
enum {
    ...
    __ROCKER_TLV_OF_DPA_STAT_MAX,
    ROCKER_TLV_OF_DPA_STAT_MAX = __ROCKER_TLV_OF_DPA_STAT_MAX - 1,
};
